						...
						<div class="tab01 p-b-20">
							...
							<div class="tab-content p-t-35">
								...
								<div class="tab-pane fade show active" id="tab1-1" role="tabpanel">
									<div class="row">
										<c:forEach items="${newss}" var = "items" >
											<c:if test="${items.menuid == item.menuid}">
										
  										<div class="col-sm-6 p-r-25 p-r-15-sr991">
											<!-- Item post -->	
											<div class="m-b-30">
												<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
													<img src="asset${items.image}" alt="IMG">
												</a>
				...
				<div class="col-md-10 col-lg-8 p-b-20">
					...
					<div class="row p-t-35">
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
									<img src="asset/images/latest-01.jpg" alt="IMG">
								</a>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
									<img src="asset/images/latest-02.jpg" alt="IMG">
								</a>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
									<img src="asset/images/latest-03.jpg" alt="IMG">
								</a>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
									<img src="asset/images/latest-04.jpg" alt="IMG">
								</a>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
									<img src="asset/images/latest-05.jpg" alt="IMG">
								</a>
						...
						<div class="col-sm-6 p-r-25 p-r-15-sr991">
							...
							<div class="m-b-45">
								<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
									<img src="asset/images/latest-06.jpg" alt="IMG">
								</a>
						...
						<div class="p-b-55">
							...
							<div>
								<div class="wrap-pic-w pos-relative">
									<img src="asset/images/video-01.jpg" alt="IMG">
