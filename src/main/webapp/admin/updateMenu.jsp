...
<body>
    ...
    <div class="form-container" style="transform: translate(110px, 20px);">
        ...
        <form action="UpdateMenuServlet" method="post">
            ...
            <div class="mb-3">
                <label for="menuname" class="form-label">Tên danh mục</label>
                <input type="text" id="menuname" name="menuname" class="form-control" value="${c.menuname}" />
            </div>
            <div class="mb-3">
                <label for="menudescription" class="form-label">Mô tả danh mục</label>
                <input type="text" id="menudescription" name="menudescription" class="form-control" value="${c.menudescription}" />
            </div>
